...
public class JMXVisitor extends AbstractPicoVisitor {
	...
	private PicoContainer picoContainer;
        ...
        /**
         * Proposed method for registering component instances that use keys that are not
         * classes.
         * @param key
         * @param objectName
         * @param mBeanInfo
         *
         */
        public void registerKeyString(String key, ObjectName objectName, MBeanInfo mBeanInfo) {
